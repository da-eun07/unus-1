...
//    int desiredValue = FORWARD_ANGLE - (command - '3') * ANGLE24; // convert char to int
    ...
    if (command == '1') {
      ...
      motor_forward(motor_left1, motor_left2, MOTOR_SPEED - 45); 
      motor_forward(motor_right1, motor_right2, MOTOR_SPEED - 45);     //-10 
    }
    else if (command == '2') {
      desiredValue = FORWARD_ANGLE + ANGLE2 + 2;
      motor_forward(motor_left1, motor_left2, MOTOR_SPEED -20); 
      motor_forward(motor_right1, motor_right2, MOTOR_SPEED-20);          //0
    }
    else if (command == '3') {
      ...
      motor_forward(motor_left1, motor_left2, MOTOR_SPEED -20);           //0
      motor_forward(motor_right1, motor_right2, MOTOR_SPEED -20);  
    }
    else if (command == '7') {
      desiredValue = FORWARD_ANGLE - ANGLE7 + 1;
      motor_forward(motor_left1, motor_left2, MOTOR_SPEED - 45);      //-10
      motor_forward(motor_right1, motor_right2, MOTOR_SPEED - 45);  
    }
